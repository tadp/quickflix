  ...
  describe "POST create" do
    ...
    context "with valid inputs" do
      it "redirects to the add new video page" do
        ...
        post :create, video: { title: "Monk", categories: [category.id], description: "good show!" }
      ...
      it "creates a video" do
        ...
        post :create, video: { title: "Monk", description: "good show!", categories: ["",comedy.id]} 
    ...
    context "with invalid inputs" do
      it "does not create a video" do
        set_current_admin
        category = Fabricate(:category)
        post :create, video: { categories: [category.id], description: "good show!" }
